...
public:
    ...
    Camera(unsigned int w, unsigned int h, const Vector3f &e, const Vector3f &r, const Vector3f &worldUp, const Float lensRadius, const Float focalDistance);
    ...
    //Implementing this in ProjectiveCamera too
